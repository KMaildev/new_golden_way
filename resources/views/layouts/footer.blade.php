                ...
                <div class="col-lg-4">
                    <div class="ht-theme-info bg-contain bg-pos-r h-100 dark-bg text-white"
                        ...
                        <div class="footer-logo">
                            <a href="index.html">
                                <img class="img-fluid" src="{{ asset('assets/images/logo-white.png') }}" alt="">
                            </a>
                        </div>
                        <p class="mb-3"> Our company which holds the recruitment license issued in Myanmar.</p> <a
                            class="btn-simple" href="#"><span>Read More <i
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="case-studies-grid-3.html">Our Activities</a>
                                        </li>
                                        <li><a href="project-grid-3.html">Contact Us</a>
                                        </li>
                                ...
                                <div class="col-sm-7">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="blog-grid-3.html">Our Organization Chart</a>
                                        </li>
                        ...
                        <div class="col-lg-6 col-md-6 mt-5 mt-md-0">
                            ...
                            <ul class="media-icon list-unstyled">
                                ...
                                <li><a href="mailto:newgoldenwayservices@gmail.com">newgoldenwayservices@gmail.com</a>
                                </li>
                                <li><a href="tel:+959 45 888 7103">+959 45 888 7103</a>
                                </li>
                                <li><a href="tel:+959 43 43 6666">+959 43 43 6666</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="copyright">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-md-end sm-mt-2"> <span>Loptus Theme by <a
                                href="#">ThemeHt</a></span>
                    </div>
                </div>
            </div>
